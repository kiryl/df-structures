...
sub generate_dt_ini($$$$$) {
    ...
    emit_addr 'flags',%all,'creature_raw','flags',$vbias;
    ...
    emit_addr 'caste_trait_ranges',%all,'caste_raw','personality';
    ...
    emit_addr 'extracts',%all,'caste_raw','extracts';
    ...
    emit_addr 'item_def',%all,'item_ammost','subtype';
    ...
    emit_addr 'syn_sick_flag',%all,'unit_syndrome','flags';
    ...
    emit_addr 'cie_first_perc',%all,'creature_interaction_effect_phys_att_changest','phys_att_perc';
    ...
    emit_addr 'traits',%all,'unit_soul','personality.traits';
    ...
    emit_addr 'uniform_indv_choice',%all,'squad_uniform_spec','indiv_choice';
